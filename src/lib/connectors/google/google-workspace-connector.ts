 ...
 * operations to the Clara OS executable connector contract.
 * ============================================
 */
 ...
 *
 * The existing service functions remain the source of truth for provider API
 * behaviour. This adapter only exposes them through Clara OS' standardized

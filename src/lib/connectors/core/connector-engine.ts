        ...
        case "google.drive": {
          if (event.capability === "store-file") {
            ...
            return this.success(
              event,
              data,
              "Google Drive file stored successfully.",
            );
          }
          ...
          if (event.capability === "retrieve-file") {
            ...
            if (!payload || typeof payload.fileId !== "string" || !payload.fileId) {
              return this.failure(
                event,
                "Google Drive retrieve-file requires fileId.",
              );
            }
            ...
            return this.success(
              event,
              data,
              "Google Drive file retrieved successfully.",
            );
          }
        ...
        case "google.docs": {
          ...
          if (event.capability === "retrieve-document") {
            ...
            return this.success(
              event,
              data,
              "Google Docs document retrieved successfully.",
            );
          }
        ...
        case "google.sheets": {
          if (event.capability === "read-spreadsheet-range") {
            ...
            return this.success(
              event,
              data,
              "Google Sheets range read successfully.",
            );
          }
